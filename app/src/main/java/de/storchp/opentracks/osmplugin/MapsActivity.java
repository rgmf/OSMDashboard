...
public class MapsActivity extends BaseActivity {
            ...
            while (cursor.moveToNext()) {
                ...
                if (Constants.isValidLocation(latitude, longitude)) {
                    ...
                    if (polyline == null) {
                        ...
                        polyline = newPolyline(trackCount);
    ...
    private static final int[] BLUE_LEVELS = {0, 255, 125, 200, 100, 225, 25, 175, 50, 75};

    private Polyline newPolyline(int trackCount) {
        return new Polyline(createPaint(
                AndroidGraphicFactory.INSTANCE.createColor(255, 0, 0, BLUE_LEVELS[trackCount % 10]),
